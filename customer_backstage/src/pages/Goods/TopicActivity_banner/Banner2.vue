        ...
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="图片缩图:" prop="pics">
            <el-upload class="upload-demo" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" multiple :limit="3" :on-exceed="handleExceed" :file-list="fileList" size="mini" :before-upload="beforeUpload" action="">
              ...
              <span class="suggestedSize">图片建议尺寸为1200*90</span>
            </el-upload>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    openModal(index, scope) {
      ...
      console.log(this.firarray)
      // this.form.Time = [new Date(arr[0]), new Date(arr[1])];
    ...
    onSubmit() {
      ...
      if(typeof(this.form.Time[0]) === 'object') {
        this.form.Time[0] = moment(this.form.Time[0]).format(
        "YYYY-MM-DD:HH:mm:ss"
        );
        this.form.Time[1] = moment(this.form.Time[1]).format(
          "YYYY-MM-DD:HH:mm:ss"
        );
      }
