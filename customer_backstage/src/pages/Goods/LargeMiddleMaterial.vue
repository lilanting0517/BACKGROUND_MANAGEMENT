<template>
  <div class="main">
    ...
    <el-dialog title="提示" :visible.sync="deleteDialogVisible" width="30%" center :close-on-click-modal='false'>
      <span>确定删除吗？</span>
    ...
    <el-dialog title="选择商品" :visible.sync="dialogTableVisible" width="70%" @close="reloadList" @open="initCurrentPageAdd" :close-on-click-modal='false'>
