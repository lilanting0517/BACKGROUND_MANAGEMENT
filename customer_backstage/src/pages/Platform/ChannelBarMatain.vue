...
<div class="main">
  ...
  <div class="tree_area">
    ...
    >
      <div>
        <el-input v-model.tirm="input" placeholder="请输入新增频道名称" size="mini"></el-input>
      </div>
    ...
    >
      <div>
        <el-input v-model.tirm="input1" placeholder="请输入频道名称" size="mini"></el-input>
      </div>
      <div slot="footer" class="dialog-footer" >
        <div style="text-align:left;margin-bottom:30px;" v-if='this.codeList.includes(this.Code)'>
          <div class="demonstration" style="margin-top:-20px;margin-bottom:20px;font-size:14px;">活动时间为：</div>
...
.tree_area {
  ...
  .el-tree-node__content{
    ...
    .el-tree-node__expand-icon {
      ...
      width: 20px;
      height: 20px;
      content: url("../../../static/hide.png");
    }
    .el-tree-node__expand-icon.expanded {
      transform: rotate(0deg);
      content: url("../../../static/show.png");
    }
